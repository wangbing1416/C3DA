...
class AdapterModel(DeltaBase):
    ...
    def add_all_delta_to_backbone(self,
        ...
        for item in module.dummy_inputs:
            module.dummy_inputs[item] = module.dummy_inputs[item].to('cuda')
    ...
    def new_module_like(self, module):
        ...
        adapterlayer = AdapterLayer(bottleneck_dim=self.bottleneck_dim, non_linearity=self.non_linearity,
